    ...
    <section className="py-12 border-t border-b border-dark-700/50 bg-dark-900/50">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <AnimatedSection delay={0.2}>
          ...
          <div className="flex items-stretch justify-between gap-3 md:gap-5">
            {/* Sources */}
            ...
            {/* Arrow from sources */}
            <div className="relative flex-shrink-0 w-6 md:w-10 flex items-center justify-center">
            ...
            <div className="flex items-center gap-1 md:gap-2">
              {layers.map((layer, i) => (
                <div key={layer.label} className="flex items-center">
                  <motion.div
                    className="relative px-3 md:px-4 py-3 rounded-xl border text-center min-w-[70px] md:min-w-[100px]"
                    style={{
                  ...
                  >
                    ...
                    {/* Processing pulse that activates sequentially */}
                    <motion.div
                  ...
                  {/* Arrow between Bronze→Silver→Gold */}
                  {i < layers.length - 1 && (
                    <motion.div
            ...
            <div className="flex flex-col gap-2 justify-center">
              {outputs.map((out, i) => (
                ...
                >
                  ...
                  <span className="hidden sm:inline">{out.label}</span>
                </motion.div>
              ))}
            </div>
          </div>
        ...
        {/* Monitoring & Alerting bar underneath */}
